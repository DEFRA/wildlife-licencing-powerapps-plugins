...
namespace SDDS.Plugin.EBG
{
	...
	public partial class Task : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sdds_advisortype")]
		public virtual sdds_AdvisorType? sdds_advisortype
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return ((sdds_AdvisorType?)(EntityOptionSetEnum.GetEnum(this, "sdds_advisortype")));
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_advisortype");
				this.SetAttributeValue("sdds_advisortype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
				this.OnPropertyChanged("sdds_advisortype");
			}
		}
		...
		public Microsoft.Xrm.Sdk.EntityReference sdds_AssessmentType
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<Microsoft.Xrm.Sdk.EntityReference>("sdds_assessmenttype");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_AssessmentType");
				this.SetAttributeValue("sdds_assessmenttype", value);
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sdds_assessmenttypes")]
		public virtual System.Collections.Generic.IEnumerable<sdds_assessment> sdds_assessmenttypes
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return EntityOptionSetEnum.GetMultiEnum<sdds_assessment>(this, "sdds_assessmenttypes");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_assessmenttypes");
				this.SetAttributeValue("sdds_assessmenttypes", EntityOptionSetEnum.GetMultiEnum(this, "sdds_assessmenttypes", value));
				this.OnPropertyChanged("sdds_assessmenttypes");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sdds_markcomplete")]
		public System.Nullable<bool> sdds_markcomplete
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<bool>>("sdds_markcomplete");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_markcomplete");
				this.SetAttributeValue("sdds_markcomplete", value);
				this.OnPropertyChanged("sdds_markcomplete");
			}
		}
		...
		/// 
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("sdds_tasksequence")]
		public System.Nullable<int> sdds_tasksequence
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetAttributeValue<System.Nullable<int>>("sdds_tasksequence");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_tasksequence");
				this.SetAttributeValue("sdds_tasksequence", value);
				this.OnPropertyChanged("sdds_tasksequence");
			}
		}
		...
		public System.Nullable<SDDS.Plugin.EBG.TaskState> StateCode
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				...
				if ((optionSet != null))
				{
					return ((SDDS.Plugin.EBG.TaskState)(System.Enum.ToObject(typeof(SDDS.Plugin.EBG.TaskState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		/// <summary>
		/// N:1 sdds_application_Tasks
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("sdds_application_Tasks")]
		public SDDS.Plugin.EBG.sdds_application sdds_application_Tasks
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SDDS.Plugin.EBG.sdds_application>("sdds_application_Tasks", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_application_Tasks");
				this.SetRelatedEntity<SDDS.Plugin.EBG.sdds_application>("sdds_application_Tasks", null, value);
				this.OnPropertyChanged("sdds_application_Tasks");
			}
		}
		
		/// <summary>
		/// N:1 sdds_license_Tasks
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("regardingobjectid")]
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("sdds_license_Tasks")]
		public SDDS.Plugin.EBG.sdds_license sdds_license_Tasks
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntity<SDDS.Plugin.EBG.sdds_license>("sdds_license_Tasks", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("sdds_license_Tasks");
				this.SetRelatedEntity<SDDS.Plugin.EBG.sdds_license>("sdds_license_Tasks", null, value);
